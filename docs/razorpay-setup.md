...
2. **Business website and app.** Account & Settings → Website & app settings (also asked during activation).
   ...
   - App: choose "Android app", give the package name `com.amitaashitsolution` and, once the Play listing is live, its Play Store URL. Until then you can submit the APK/bundle for review if the dashboard asks for it.
