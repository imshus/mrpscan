...
const styles = StyleSheet.create({
  ...
  updated: { fontSize: 9.5, color: Colors.textMuted, marginTop: 1 },
  tick: {
    width: 19,
    height: 19,
    borderRadius: 5,
  ...
  rowLabel: { flex: 1, fontSize: 11, color: Colors.textSecondary },
  rowValue: { fontSize: 12, fontWeight: '800', color: Colors.accentGold },
  ...
  bhawLabel: { fontSize: 9, color: Colors.textMuted },
  bhawValue: { fontSize: 14, fontWeight: '800', color: Colors.textPrimary, marginTop: 0 },
});
