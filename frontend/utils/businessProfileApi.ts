 ...
 * database.
 *
 * The app caches these details at login, so a rename, or a GST record repaired
 * after signup, would otherwise keep showing the stale copy until the next
 * sign-in. Returns null on failure so callers keep displaying the cache rather
